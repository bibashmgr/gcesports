...
<body>
    ...
    <section class="teams-lists">
        ...
        <h1>CHESS PARTICIPANTS</h1>

        <form action="./tabletennis.php" id="search-form" class="team-search-form">
        ...
        <?php for ($i = 0; $i < 4; $i++) : ?>
            <?php for ($k = 0; $k < 2; $k++) : ?>
                ...
                <?php $teams = selectAll($table, ['teamname' => $teamnames[$i], 'teamfaculty' => $teamfacultys[$k]]); ?>

                <?php if (count($teams) != 0) : ?>
                    <div class="table-container" id="<?php echo ("table-" . $x); ?>">

                        <h2 style="margin-top:30px; text-transform:capitalize;">
                            <?php echo $teamnames[$i] . " (" . $teamfacultys[$k] . "):"; ?>
                        </h2>
    ...
    <script>
        ...
        const selectTeam = () => {
            if (year.value == '' || faculty.value == '') {
                window.alert("Invalid input")
            } else {

                if (year.value == 'first year' && faculty.value == 'COM') {
                ...
                if (year.value == 'first year' && faculty.value == 'SOF') {
                    teamAll.forEach(function(element) {
                        element.setAttribute("style", "display:none");
                    });
                ...
                if (year.value == 'second year' && faculty.value == 'COM') {
                    teamAll.forEach(function(element) {
                        element.setAttribute("style", "display:none");
                    });
                ...
                if (year.value == 'second year' && faculty.value == 'SOF') {
                    teamAll.forEach(function(element) {
                        element.setAttribute("style", "display:none");
                    });
                ...
                if (year.value == 'third year' && faculty.value == 'COM') {
                    teamAll.forEach(function(element) {
                        element.setAttribute("style", "display:none");
                    });
                ...
                if (year.value == 'third year' && faculty.value == 'SOF') {
                    teamAll.forEach(function(element) {
                        element.setAttribute("style", "display:none");
                    });
                ...
                if (year.value == 'fourth year' && faculty.value == 'COM') {
                    teamAll.forEach(function(element) {
                        element.setAttribute("style", "display:none");
                    });
                ...
                if (year.value == 'fourth year' && faculty.value == 'SOF') {
                    teamAll.forEach(function(element) {
                        element.setAttribute("style", "display:none");
                    });
